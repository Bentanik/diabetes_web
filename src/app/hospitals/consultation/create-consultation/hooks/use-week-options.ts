...
const generateWeekOptionsForMonth = (year: number, month: number): WeekOption[] => {
...
export const useWeekOptions = () => {
	...
	const weekOptions = useMemo(() => {
		...
		return generateWeekOptionsForMonth(parseInt(selectedYear, 10), parseInt(selectedMonth, 10));
	...
	}, [selectedWeekData?.weekStart?.getTime(), selectedWeekData?.weekEnd?.getTime()]);
