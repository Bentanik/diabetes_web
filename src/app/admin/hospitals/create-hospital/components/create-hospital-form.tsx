...
import useCreateHospital, { HospitalFormData } from "@/app/admin/hospitals/create-hospital/hooks/use-create-hospital"
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(handleFormSubmit)} className="space-y-8">
                    ...
                    <motion.div variants={itemVariants} className="space-y-4">
                        ...
                        <p className="text-sm text-gray-500">Chấp nhận file JPG, PNG. Kích thước tối đa 5MB.</p>
                    </motion.div>
                    ...
                    {/* Submit Buttons */}
                    <motion.div variants={itemVariants} className="flex justify-end gap-4 pt-8 border-t-2 border-gray-100">
                        <Button
                            type="button"
                            variant="outline"
