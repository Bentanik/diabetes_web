...
import useEditKnowledgeBase from "@/app/admin/train-ai/hooks/useEditKnowledgeBase";

interface EditKnowlegeModalProps {
    isOpen: boolean;
    onClose: () => void;
    knowledge: API.TKnowledge;
}
 ...
 */
export default function EditKnowlegeModal({
    isOpen,
    onClose,
    knowledge,
}: EditKnowlegeModalProps) {
    const { register, handleSubmit, errors, onSubmit, isEditing, reset } =
        useEditKnowledgeBase(knowledge);
                ...
                <div className="relative bg-[#248fca] p-6">
                    ...
                    >
                        ...
                        <div>
                            ...
                            >
                                Chỉnh sửa cơ sở tri thức cho hệ thống AI
                            </motion.p>
                        </div>
                    </motion.div>
