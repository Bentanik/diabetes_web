...
import { UpdateDocumentFormData } from "@/lib/validations/document.schema"
...
export default function EditDocumentModal({ isOpen, onClose, document }: EditDocumentModalProps) {
    const { register, handleSubmit, errors, onSubmit, reset } = useUpdateDocument(document)

    const handleSubmitForm = (data: UpdateDocumentFormData) => {
                ...
                <div className="relative bg-[#248fca] p-6">
                    ...
                    >
                        ...
                        <div>
                            ...
                            >
                                Cập nhật thông tin tài liệu {document.title}
                    ...
                    >
                        ...
                        >
                            ...
                            <InputTrainAI
                                ...
                                placeholder="Nhập tiêu tài liệu..."
                                disabled={false}
                            />
                        </motion.div>
                        {/* Mô tả */}
